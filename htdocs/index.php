...
$result = mysqli_query($mysqli, "SELECT * FROM db_portofolio ORDER BY id DESC");
...
if (isset($_POST['email'])) {
    ...
    $add = mysqli_query($mysqli, "INSERT INTO form(name,email,subject,message) VALUES('$name','$email', '$subject', $message NOW())");
}
?>
